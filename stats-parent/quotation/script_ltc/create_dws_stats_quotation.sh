...
sql = "create table IF NOT EXISTS liutongchun.dws_stats_quotation(
...
hive --database liutongchun -e "${sql}"
...
//建表
hive --database liutongchun \
-e "create table IF NOT EXISTS liutongchun.dws_stats_quotation(
dim String COMMENT '分析的维度',
index String comment '分析的指标',
obj_type String comment '分析对象的类型',
obj_value String comment '分析的对象',
